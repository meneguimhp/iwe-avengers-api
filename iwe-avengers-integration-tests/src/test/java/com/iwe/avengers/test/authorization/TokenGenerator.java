...
public class TokenGenerator {
	...
	public String getToken() {
		...
		final String clientId = "26ls4usbrdrjods528lqrmlofs";
		final String userPoolId = "us-east-1_xbHFUOPmh";
		...
		initiateAuthRequest.addAuthParametersEntry("USERNAME", "tiago.meneguim");
